...
datagen = ImageDataGenerator(rotation_range=20,
                            fill_mode='nearest', #Fills in any pixels that might be generated by the above transformations. The 'nearest' fill mode uses the nearest pixel value to fill in these pixels.
                            zoom_range=[0.9, 1.1],  # Set zoom range from -10% to +10%
